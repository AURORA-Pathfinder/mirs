...
if (NOT TARGET hdf5::hdf5_hl)
	...
	if(NOT "${HDF5_MAIN_HL_LIB}" STREQUAL "")
		set_target_properties(hdf5::hdf5_hl PROPERTIES IMPORTED_LOCATION ${HDF5_MAIN_HL_LIB})
		set_target_properties(hdf5::hdf5_hl PROPERTIES LINK_LIBRARIES "${HDF5_HL_LIBRARIES}")
